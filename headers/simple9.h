...
public:
    ...
    enum {
        SIMPLE9_LOGDESC = 4, SIMPLE9_LEN = (1U << SIMPLE9_LOGDESC)
    };
...
const typename Simple9<MarkLength, hacked>::unpacker
        Simple9<MarkLength, hacked>::unpackarray[SIMPLE9_LEN] = { unpack1_28,
                unpack2_14, unpack3_9, unpack4_7, unpack5_5, unpack7_4,
...
template<bool MarkLength, bool hacked>
const uint32_t * Simple9<MarkLength, hacked>::decodeArray(const uint32_t *in,
...
template<bool MarkLength, bool hacked>
void Simple9<MarkLength, hacked>::unpack4_7(uint32_t **out, const uint32_t **in) {
    uint32_t *pout;
    const uint32_t *pin;
...
template<bool MarkLength, bool hacked>
void Simple9<MarkLength, hacked>::unpack7_4(uint32_t **out, const uint32_t **in) {
    uint32_t *pout;
    const uint32_t *pin;
...
template<bool MarkLength, bool hacked>
void Simple9<MarkLength, hacked>::unpack3_9(uint32_t **out, const uint32_t **in) {
    uint32_t *pout;
    const uint32_t *pin;
...
template<bool MarkLength, bool hacked>
void Simple9<MarkLength, hacked>::unpack5_5(uint32_t **out, const uint32_t **in) {
    uint32_t *pout;
    const uint32_t *pin;
...
template<bool MarkLength, bool hacked>
void Simple9<MarkLength, hacked>::unpack9_3(uint32_t **out, const uint32_t **in) {
    uint32_t *pout;
    const uint32_t *pin;
