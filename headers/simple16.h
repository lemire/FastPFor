...
class Simple16: public IntegerCODEC {
public:
    ...
    static void
    unpack4_1_3_8(uint32_t **out, const uint32_t **in);
    static void unpack3_1_4_4_3_3(uint32_t **out, const uint32_t **in);
    static void unpack4_7(uint32_t **out, const uint32_t **in);
    static void
    unpack5_4_4_2(uint32_t **out, const uint32_t **in);
    static void
    unpack4_2_5_4(uint32_t **out, const uint32_t **in);
    static void
    unpack6_3_5_2(uint32_t **out, const uint32_t **in);
    static void
    unpack5_2_6_3(uint32_t **out, const uint32_t **in);
...
const typename Simple16<MarkLength>::unpacker
        Simple16<MarkLength>::unpackarray[SIMPLE16_LEN] = { unpack1_28,
                unpack2_7_1_14, unpack1_7_2_7_1_7, unpack1_14_2_7, unpack2_14,
                unpack4_1_3_8, unpack3_1_4_4_3_3, unpack4_7, unpack5_4_4_2,
                unpack4_2_5_4, unpack6_3_5_2, unpack5_2_6_3, unpack7_4,
                unpack10_1_9_2, unpack14_2, unpack28_1 };
...
template<bool MarkLength>
void Simple16<MarkLength>::fakeencodeArray(const uint32_t *in, const size_t length, size_t &nvalue) {
