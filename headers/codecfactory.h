...
map<string, shared_ptr<IntegerCODEC> > CODECFactory::scodecmap = {
    ...
    {  "fastpfor2", shared_ptr<IntegerCODEC> (new CompositeCodec<FastPFor2<Simple16<true> > , VariableByte> ())},
    {  "fastpfor2-9", shared_ptr<IntegerCODEC> (new CompositeCodec<FastPFor2<Simple9<true> > , VariableByte> ())},
    {  "fastpfor2-8b", shared_ptr<IntegerCODEC> (new CompositeCodec<FastPFor2<Simple8b<true> > , VariableByte> ())},
